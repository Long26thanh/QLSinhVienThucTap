...
namespace QLSinhVienThucTap.DTO
{
    public class ThucTap
    {
        ...
        public ThucTap(string maThucTap, string maSinhVien, string maGiaoVien, string maDeTai, string maDiaDiem, string maDotThucTap, string hoTenSV, string hoTenGV, string tenDeTai, string tenDiaDiem, string tenDotThucTap, float? diemSo = null)
        {
